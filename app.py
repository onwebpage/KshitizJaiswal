...
app.config['MAX_CONTENT_LENGTH'] = 100 * 1024 * 1024  # 100MB max (for short video uploads)
...
with app.app_context():
    ...
    try:
        ...
        _add_column("reel",               "youtube_url",          "VARCHAR(500)")
        _add_column("reel",               "instagram_reel_url",   "VARCHAR(500)")
